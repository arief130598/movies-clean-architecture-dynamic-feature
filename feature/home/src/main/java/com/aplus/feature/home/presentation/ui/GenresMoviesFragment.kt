...
import com.aplus.feature.home.databinding.FragmentGenresMoviesBinding
import com.aplus.feature.home.presentation.viewmodel.GenresMoviesViewModel
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject

@AndroidEntryPoint
class GenresMoviesFragment : Fragment() {

    private lateinit var binding: FragmentGenresMoviesBinding
    private val viewModel : GenresMoviesViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_genres_movies,
            container,
            false
        )
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?): Unit = with(binding){
        ...
        viewModel.currentGenres =
            GenresMoviesFragmentArgs.fromBundle(requireArguments()).genresArg.removeFirstAndLast()
            ...
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (layoutManager.findLastCompletelyVisibleItemPosition() == adapter.itemCount - 1){
                    if (!loadingMore) {
                        ...
                        viewModel.getMovies(viewModel.currentGenres)
                    }
                }
            }
    ...
    private fun observer() = with(viewModel) {
        collectLatestLifecycleFlow(genres){
            adapter.setGenre(it)
            getMovies(viewModel.currentGenres)
        }
